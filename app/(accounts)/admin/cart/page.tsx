...
import { BsCashCoin, BsDashLg, BsPlusLg } from "react-icons/bs";
          ...
          <div className="3/6 lg:basis-3/5   h-full w-full flex flex-col gap-5">
            ...
            >
              <div className="flex flex-col gap-5 bg-white shadow-lg rounded-lg p-10">
                <div className="text-lg font-bold p-3 bg-darkviolet rounded-lg text-white">
                  Shipping address
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex flex-col col-span-2 gap-2">
                    ...
                    <div className="flex flex-row gap-10">
                      <div className="flex flex-row gap-2">
                        <input
                          type="radio"
                          className=" accent-darkviolet h-5 w-5"
                          checked
                        />
                  ...
                  <div className="flex flex-col col-span-1">
                    ...
                    <input
                      type="text"
                      placeholder="John"
                      className="border h-10 rounded-lg focus:outline-none border-brandviolet px-2 text-sm"
                    />
                  </div>
                  <div className="flex flex-col col-span-1">
            ...
            >
              <div className="flex flex-col gap-5 bg-white shadow-lg rounded-lg p-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="text-sm text-gray-400 col-span-1 md:col-span-2">
                ...
                <div className="flex flex-col  ">
                  ...
                  <div className="flex flex-row justify-between pt-5 mb-2">
                    <div className="flex flex-row gap-2 items-center">
                      <input
                        type="checkbox"
                        className=" accent-darkviolet h-4 w-4"
                      />
                  ...
                  <div className="flex flex-col gap-5 divide-y-2">
                    <div className="flex flex-row gap-2 justify-between  items-center w-full">
                      <div className="flex flex-row gap-2 items-center w-full">
                        <input
                          type="checkbox"
                          className=" accent-darkviolet h-3 w-3"
                        />
                      ...
                      <div className="flex justify-evenly gap-5 items-center">
                        <button className="bg-darkviolet p-2 text-white rounded-full">
                          <BsDashLg />
                        </button>
                  ...
                  <div className="flex flex-col gap-5 mt-10 border-t-2 border-dashed">
                    ...
                    <button className="border border-darkviolet hover:bg-darkviolet/10 font-medium text-darkviolet w-full p-2  rounded-lg">
                      Checkout
                    </button>
                  </div>
                </div>
